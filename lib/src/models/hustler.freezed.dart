...
mixin _$Hustler {
 ...
 String get uid; String get email; String get name; List<String> get skills; DateTime get createdAt; String? get bio; String? get experience; String? get location; String? get phoneNumber; String? get photoUrl; double? get rating; int? get completedJobs;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Hustler&&(identical(other.uid, uid) || other.uid == uid)&&(identical(other.email, email) || other.email == email)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.skills, skills)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.experience, experience) || other.experience == experience)&&(identical(other.location, location) || other.location == location)&&(identical(other.phoneNumber, phoneNumber) || other.phoneNumber == phoneNumber)&&(identical(other.photoUrl, photoUrl) || other.photoUrl == photoUrl)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.completedJobs, completedJobs) || other.completedJobs == completedJobs));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,email,name,const DeepCollectionEquality().hash(skills),createdAt,bio,experience,location,phoneNumber,photoUrl,rating,completedJobs);

@override
String toString() {
  return 'Hustler(uid: $uid, email: $email, name: $name, skills: $skills, createdAt: $createdAt, bio: $bio, experience: $experience, location: $location, phoneNumber: $phoneNumber, photoUrl: $photoUrl, rating: $rating, completedJobs: $completedJobs)';
}
...
@useResult
$Res call({
 String uid, String email, String name, List<String> skills, DateTime createdAt, String? bio, String? experience, String? location, String? phoneNumber, String? photoUrl, double? rating, int? completedJobs
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String email,  String name,  List<String> skills,  DateTime createdAt,  String? bio,  String? experience,  String? location,  String? phoneNumber,  String? photoUrl,  double? rating,  int? completedJobs)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Hustler() when $default != null:
return $default(_that.uid,_that.email,_that.name,_that.skills,_that.createdAt,_that.bio,_that.experience,_that.location,_that.phoneNumber,_that.photoUrl,_that.rating,_that.completedJobs);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String email,  String name,  List<String> skills,  DateTime createdAt,  String? bio,  String? experience,  String? location,  String? phoneNumber,  String? photoUrl,  double? rating,  int? completedJobs)  $default,) {final _that = this;
switch (_that) {
case _Hustler():
return $default(_that.uid,_that.email,_that.name,_that.skills,_that.createdAt,_that.bio,_that.experience,_that.location,_that.phoneNumber,_that.photoUrl,_that.rating,_that.completedJobs);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uid,  String email,  String name,  List<String> skills,  DateTime createdAt,  String? bio,  String? experience,  String? location,  String? phoneNumber,  String? photoUrl,  double? rating,  int? completedJobs)?  $default,) {final _that = this;
switch (_that) {
case _Hustler() when $default != null:
return $default(_that.uid,_that.email,_that.name,_that.skills,_that.createdAt,_that.bio,_that.experience,_that.location,_that.phoneNumber,_that.photoUrl,_that.rating,_that.completedJobs);case _:
  return null;
...
class _Hustler implements Hustler {
  const _Hustler({required this.uid, required this.email, required this.name, required final  List<String> skills, required this.createdAt, this.bio, this.experience, this.location, this.phoneNumber, this.photoUrl, this.rating, this.completedJobs}): _skills = skills;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,email,name,const DeepCollectionEquality().hash(_skills),createdAt,bio,experience,location,phoneNumber,photoUrl,rating,completedJobs);
